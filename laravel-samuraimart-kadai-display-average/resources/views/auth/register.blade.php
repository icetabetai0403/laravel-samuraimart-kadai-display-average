        ...
        <div class="col-md-5">
            ...
            <form action="{{ route('register') }}" method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-7">
                        <input type="text" id="name" class="form-control @error('name') is-invalid @enderror samuraimart-login-input" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus placeholder="侍 太郎">

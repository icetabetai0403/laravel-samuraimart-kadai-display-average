          ...
          <div class="col-12">
            <p class="samuraimart-product-label mt-2 mb-0">
              ...
              <div class="d-flex align-items-center">
                <div class="star-rating d-flex" data-rate="{{ round($recommend_product->reviews->avg('score') * 2) / 2 }}"></div><div class="average-review-rate d-flex ms-1">{{ round($recommend_product->reviews->avg('score'), 1) }}</div>
              </div>
        ...
        <div class="row">
          <div class="col-12">
            <p class="samuraimart-product-label mt-2 mb-0">
              ...
              <div class="d-flex align-items-center">
                <div class="star-rating d-flex" data-rate="{{ round($recently_product->reviews->avg('score') * 2) / 2 }}"></div><div class="average-review-rate d-flex ms-1">{{ round($recently_product->reviews->avg('score'), 1) }}</div>
              </div>

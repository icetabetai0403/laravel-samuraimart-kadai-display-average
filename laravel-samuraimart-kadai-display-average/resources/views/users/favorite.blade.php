  ...
  <div class="w-75">
    ...
    <div class="row">
      ...
      <div class="col-md-2 d-flex align-items-center justify-content-end">
        ...
        <form action="{{ route('favorites.destroy', $favorite_product->id) }}" id="favorites-destroy-form{{ $favorite_product->id }}" method="POST" class="d-none">
          @csrf
          @method('DELETE')
        </form>
      </div>
      <div class="col-md-3 d-flex align-items-center justify-content-end">
        <form action="{{ route('cart.store') }}" method="POST" class="m-3 align-items-end">
          @csrf
